...
int test_shared1() {
    ...
    int result = 1;
    if (a.get()->get_student_id() != 201950219) {
        result = 0;
        std::string str("test_shared1: Error is a->get_student_id() != 201950219");
        print_error(str);
    }

    if (b.get()->get_student_id() != 201950221) {
        result = 0;
